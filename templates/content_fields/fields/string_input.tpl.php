<div class="w2dc_field w2dc_field_input_block w2dc_field_input_block_<?php echo $content_field->id; ?>">
	...
	<input type="text" name="w2dc_field_input_<?php echo $content_field->id; ?>" class="w2dc_field_input_string" value="<?php echo esc_attr($content_field->value); ?>" size="<?php echo $content_field->input_size; ?>" />
