...
<form method="POST" action="">
	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				<th scope="row">
					<label><?php _e('Input HTML field size',  'W2DC'); ?><span class="red_asterisk">*</span></label>
				</th>
				<td>
					<input
						name="input_size"
						type="text"
						size="2"
						value="<?php echo esc_attr($content_field->input_size); ?>" />
				</td>
			</tr>
			<tr>
				<th scope="row">
					<label><?php _e('PHP RegEx template',  'W2DC'); ?>
				</th>
				<td>
					<input
						name="regex"
