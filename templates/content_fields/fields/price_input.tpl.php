<div class="w2dc_field w2dc_field_input_block w2dc_field_input_block_<?php echo $content_field->id; ?>">
	...
	<?php echo $content_field->currency_symbol; ?>&nbsp;&nbsp;<input type="text" name="w2dc_field_input_<?php echo $content_field->id; ?>" class="w2dc_field_input_price" value="<?php echo esc_attr($content_field->value); ?>" size="4" />
