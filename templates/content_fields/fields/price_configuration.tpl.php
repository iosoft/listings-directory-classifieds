...
<form method="POST" action="">
	...
	<table class="form-table">
		<tbody>
			<tr>
				<th scope="row">
					<label><?php _e('Currency symbol', 'W2DC'); ?><span class="red_asterisk">*</span></label>
				</th>
				<td>
					<input
			...
			<tr>
				<th scope="row">
					<label><?php _e('Currency code', 'W2DC'); ?><span class="red_asterisk">*</span></label>
				</th>
				<td>
					<input
						name="currency_code"
			...
			<tr>
				<th scope="row">
					<label><?php _e('Decimal separator', 'W2DC'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<label><?php _e('Thousands separator', 'W2DC'); ?>
				</th>
				<td>
