...
<h2>
	<?php _e('Renew listing', 'W2DC'); ?>
</h2>

<p><?php _e('Listing will be renewed and raised up to the top of all lists, those ordered by date.', 'W2DC'); ?></p>

<?php apply_filters('w2dc_renew_html', $listing); ?>

<?php if ($action == 'show'): ?>
<a href="<?php echo admin_url('options.php?page=w2dc_renew&listing_id=' . $listing->post->ID . '&renew_action=raiseup&referer=' . urlencode($referer)); ?>" class="button button-primary"><?php _e('Renew listing', 'W2DC'); ?></a>
&nbsp;&nbsp;&nbsp;
