...
<form method="POST" action="">
	...
	<table class="form-table">
		<tbody>
			<tr>
				<th scope="row">
					<label><?php _e('Level name', 'W2DC'); ?><span class="red_asterisk">*</span></label>
				</th>
				<td>
					<input
						name="name"
			...
			<tr>
				<th scope="row">
					<label><?php _e('Listing logo size', 'W2DC'); ?></label>
				</th>
				<td>
					<select name="logo_size" />
						<option value="thumbnail" <?php selected($level->logo_size, 'thumbnail'); ?> ><?php _e('thumbnail', 'W2DC'); ?></option>
						<option value="medium" <?php selected($level->logo_size, 'medium'); ?> ><?php _e('medium', 'W2DC'); ?></option>
						<option value="large" <?php selected($level->logo_size, 'large'); ?> ><?php _e('large', 'W2DC'); ?></option>
					</select>
				</td>
			</tr>
			<tr>
