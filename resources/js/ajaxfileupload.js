function ajaxImageFileUploadToGallery(crop, process_url, error_file_choose) {
	if (jQuery("#browse_file").val() != '') {
		ajax_loader_show();
			...
			success: function (data, status) {
				if(typeof(data.error_msg) != 'undefined') {
					if(data.error_msg != '') {
						...
						ajax_loader_hide();
						jQuery("#upload_wrapper").show();
					} else {
						addImageDiv(data.uploaded_file, data.attachment_id);
						jQuery("#upload_wrapper").show();
						ajax_loader_hide();
					}
				} else {
